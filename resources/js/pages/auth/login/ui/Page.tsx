    ...
    <>
        ...
        <div>
          ...
          <div className="mt-16">
            ...
            <p className="mt-4 max-w-sm text-sm leading-relaxed text-white/60">
              Войдите в личный кабинет для управления заказами, отслеживания доставки и доступа к персональным условиям.
            </p>
          </div>
      ...
      <div className="flex flex-1 flex-col items-center justify-center bg-bg-primary px-6 py-10">
        <div className="w-full max-w-[400px]">
          ...
          <h2 className="text-2xl font-bold text-text-primary">Вход в аккаунт</h2>
          <p className="mt-2 text-sm text-text-tertiary">
            Войдите для управления заказами и покупками
          </p>
